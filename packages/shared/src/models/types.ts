...
// Key alias used in some shared components
...
export interface MovementTemplate extends Omit<
  MovementTemplateRow,
  "muscle_groups"
> {
...
export interface CreateUserMovementRequest extends Omit<
  TablesInsert<"user_movements">,
  "user_id"
> {
