    ...
    <div className="space-y-3 sm:space-y-4">
      ...
      <div className="space-y-3">
        <div className="flex items-center space-x-2">
          <h2 className="text-base sm:text-lg font-semibold">Workout Management</h2>
        </div>
        ...
        <div className="space-y-2">
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div className="text-left">
                <p className="font-medium text-sm sm:text-base">Create New Workout</p>
                <p className="text-xs sm:text-sm text-primary-foreground/80">Start building your routine</p>
              </div>
            </div>
          </Button>
          ...
          <Button variant="outline" asChild className="w-full justify-start h-auto p-3 sm:p-4">
            <Link href="/library" className="flex items-center space-x-3">
              ...
              <div className="text-left">
                <p className="font-medium text-sm sm:text-base">Browse Movement Library</p>
                <p className="text-xs sm:text-sm text-muted-foreground">Explore exercises and create workouts</p>
              </div>
            </Link>
          </Button>
        </div>
