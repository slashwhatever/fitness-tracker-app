...
type TypographyVariants = "title1" | "title2" | "title3" | "body" | "caption" | "footnote"
...
export const Typography = ({ children, className, variant = "body", as }: TypographyProps) => {
  ...
  const Tag = as || (variant === "title1" ? "h1" : variant === "title2" ? "h2" : variant === "title3" ? "h3" : variant === "body" ? "p" :  variant === "caption" ? "p" : variant === "footnote" ? "p" : "p");
