...
import { useAddMovementsToWorkout, useRemoveMovementsFromWorkout, useWorkoutMovements } from '@/hooks';
...
export function BatchMovementsExample({ workoutId, selectedMovementIds, movementIdsToRemove }: BatchMovementsProps) {
  ...
  const handleAddMovements = async () => {
    ...
    try {
      ...
      console.log(`Successfully added ${selectedMovementIds.length} movements in one batch`);
    } catch (error) {
  ...
  const handleRemoveMovements = async () => {
    ...
    try {
      ...
      console.log(`Successfully removed ${movementIdsToRemove.length} movements in one batch`);
    } catch (error) {
