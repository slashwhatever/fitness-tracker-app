    ...
    <>
      <div className="flex flex-row justify-between items-center">
        ...
        <div className="flex items-center space-x-1 sm:space-x-2 flex-shrink-0 ml-2 sm:ml-4">
          <ResponsiveButton icon={Copy} color="green" onClick={handleDuplicate}>
            <Typography variant="body">Duplicate</Typography>
          </ResponsiveButton>

          <Drawer open={isEditing} onOpenChange={handleDrawerOpenChange}>
            <DrawerTrigger asChild>
              <ResponsiveButton title="Edit" icon={Edit} color="blue">
            ...
            <DrawerContent className="!max-h-[95vh]">
              <div className="max-w-4xl mx-auto">
                <DrawerHeader>
                  ...
                  <DrawerDescription>
                    Modify the values for this set from {formattedDate} at{" "}
                    {formattedTime}
                  </DrawerDescription>
                </DrawerHeader>
