  ...
  return (
    <SafeAreaView className="flex-1 bg-dark-bg">
      <ScrollView contentContainerClassName="p-4 pb-24">
        ...
        <View className="bg-dark-card p-4 rounded-2xl border border-dark-border mb-4">
          ...
          <Text className="text-gray-500 text-sm">5 exercises • 45 mins</Text>
        </View>

        <View className="bg-dark-card p-4 rounded-2xl border border-dark-border">
          <View className="flex-row justify-between items-center mb-2">
            <Text className="text-white font-semibold text-lg">Leg Day</Text>
            <Text className="text-gray-400 text-sm">3 days ago</Text>
          </View>
          <Text className="text-gray-500 text-sm">6 exercises • 60 mins</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
